                        ...
                        <div class="row tooltipped" data-position="right" data-delay="50" data-tooltip="What type of event is it?">
                            <div class="input-field col s8 m6 l4 offset-m1 offset-l1">
                                <select class="icons" >
                                  ...
                                  <option value="" data-icon="img/festival.png" class="left circle">Festival</option>
                                  <option value="" data-icon="img/hiphop.png" class="left circle">Hip hop</option>
                                  <option value="" data-icon="img/party.png" class="left circle">Party</option>
                                  <option value="" data-icon="img/rock.png" class="left circle">Rock</option>
                                  <option value="" data-icon="img/techno.png" class="left circle">Techno</option>
                                </select>
