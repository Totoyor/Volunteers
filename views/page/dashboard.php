                ...
                <div class="row">
                    ...
                    <div class="col l9 m12 s12">
                        <div class="card panel">
                            ...
                            <div class="grey-text panel-text">
                                <p class="nospace">Here is your dashboard, follow the links below to complete your profile, to find an event or to create one. You can also invite your friends and enjoy some benefits !</p>
                                
                                <ul class="nostyle-list">
                                    <li class="space2"><strong><a href="editprofile.php">Complete your profile</a></strong>
                                        <p class="nospace">Complete your profile by being as clear as possible so the organizers can really know who they are hiring and why they are intersted in you.</p>
                                    </li>
                                    
                                    <li class="space2"><strong><a href="#">Find events you like</a></strong>
                                        <p class="nospace">Téléchargez une photo et présentez-vous rapidement pour aider les organisateurs à vous connaître avant qu'ils ne vous contactent.</p>
                                    </li>
                            ...
                            <div class="grey-text panel-text">
                                <div class="row">
                                    <div class="col l7 m7 s12">
                                        <p class="nospace">You have no mission right now but try to find an event to become a Volunteer !</p>
                                    </div>
                        ...
                        <div class="card panel">
                            ...
                            <div class="grey-text panel-text">
                                <div class="row">
                                    <div class="col l7 m7 s12">
                                        <p class="nospace">You have no events right now. Create your event to work with the best volunteers.</p>
                                    </div>
                        ...
                        <div class="card panel">
                            ...
                            <div class="grey-text panel-text">
                                <div class="row">
                                    <div class="col l7 m7 s12">
                                        <p class="nospace">Invite your friends and earn benefits on the Volunteers website.</p>
                                    </div>
