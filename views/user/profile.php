                ...
                <div class="col l3 m12 s12">
                    <div class="card">
                        <div class="card-image">
                            <img class="responsive-img" src="assets/img/square_face.png">
                        </div>
                            ...
                            <div class="grey-text panel-text">
                                ...
                                <div class="row">
                                    <div class="col s9 m9">
                                        ...
                                        <div class="select">
                                            <select class="browser-default name=""birth-day">
                        ...
                        <div class="card panel">
                            ...
                            <div class="grey-text panel-text">
                                ...
                                <div class="row">
                                    <div class="col l6 s12">
                                        <div class="input-field">
                                            <input placeholder="Apple / Carrefour Market" id="work" type="text"
                                                   class="validate">
